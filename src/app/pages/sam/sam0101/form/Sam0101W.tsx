...
import AppDateRange from '../../../../components/commons/AppDateRange';
import AppRadioButton from '../../../../components/commons/AppRadioButton';
            ...
            <form onSubmit={handleSave}>
                ...
                <div className='row'>
                    <div className='col-lg-6 mb-3'>
                        {/* <AppDatePickerRange value={{ fromDate: model.fromDate, toDate: model.toDate }}
                        styleFromDate={{ title: `${t('sample.label.fromdate')}`, required: true, message: `${t('sam0101w.required.message.date')}` }}
                        styleToDate={{ title: `${t('sample.label.todate')}`, required: false, message: `${t('sam0101w.required.message.date')}` }}
